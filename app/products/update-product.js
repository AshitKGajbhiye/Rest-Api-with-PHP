$(document).ready(function(){
    ...
    $(document).on('click', '.update-product-button', function(){
		...
		$.getJSON("http://devphp/rest_examples/product/read_one.php?id=" + id, function(data){
			...
			$.getJSON("http://devphp/rest_examples/category/read.php", function(data){
	...
	$(document).on('submit', '#update-product-form', function(){
		...
		$.ajax({
		    url: "http://devphp/rest_examples/product/update.php",
		    type : "POST",
