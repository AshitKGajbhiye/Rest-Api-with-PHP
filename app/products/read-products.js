...
function showProducts(){
	...
	$.getJSON("http://devphp/rest_examples/product/read.php", function(data){
		...
		read_products_html+="<table class='table table-bordered table-hover'>";
		 ...
		 //Add by me
		 //console.log(read_products_html);
...
/*// For We want the "product list" and "search product" have the same HTML table template.
// function to show list of products
function showProducts(){
...
function showProductsFirstPage(){
    var json_url="http://devphp/rest_examples/product/read_paging.php";
    showProducts(json_url);
}
